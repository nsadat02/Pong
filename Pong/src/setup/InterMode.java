...
public class InterMode extends BasicGameState{
    Image paddle,paddle2,ball,block,block2,pauseMenu,player1,player2;
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        this.block = new Image("block.png");
        this.block2 = new Image("block.png");
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int i) throws SlickException {
     ...
     if(pause==false){
        ...
        if(ballX>0 && ballX +20<gc.getWidth()){
            if(ballY==0){
                y*=-1;
            }
        ...
        if(ballX<=blockX+99 && ballX+19>=blockX && blockY==ballY+20){
            y*=-1;
        }
        else if(ballX<=blockX+99 && ballX+19>=blockX && blockY+100==ballY){
            y*=-1;
        }
        else if(ballX<=blockX+99 && ballX+19>=blockX && blockY2==ballY+20){
            y*=-1;
        }
        else if(ballX<=blockX+99 && ballX+19>=blockX && blockY2+100==ballY){
            y*=-1;
        }
        if(ballY +19>=blockY && ballY<=blockY+99 && blockX==ballX+20){
            x*=-1;
        }
        else if(ballY +19>=blockY && ballY<=blockY+99 && blockX+100==ballX){
            x*=-1;
        }
        else if(ballY +19>=blockY2 && ballY<=blockY2+99 && blockX==ballX+20){
            x*=-1;
        }
        else if(ballY +19>=blockY2 && ballY<=blockY2+99 && blockX+100==ballX){
            x*=-1;
        }
